...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                ...
                case 5: jamss = "Shalat Subuh"; break;
                case 6: jamss = "Selamat Pagi"; break;
                case 7: jamss = "Selamat Pagi"; break;
                case 8: jamss = "Selamat Pagi"; break;
                case 9: jamss = "Selamat Siang"; break;
                case 10: jamss = "Selamat Siang"; break;
                case 11: jamss = "Selamat Siang"; break;
                case 12: jamss = "Shalat Zuhur"; break;
                case 13: jamss = "Selamat Siang"; break;
                case 14: jamss = "Selamat Siang"; break;
                case 15: jamss = "Shalat Asar"; break;
                case 16: jamss = "Selamat Sore"; break;
                case 17: jamss = "Selamat Sore"; break;
                case 18: jamss = "Shalat Maghrib"; break;
                case 19: jamss = "Shalat Isha"; break;
...
const daftar1 = `*Verify Dulu Cuy*`
const daftar2 = '_klik button di bawah untuk daftar_'
...
reply(String(e))
			...
			for (let anji of setik){
				if (budy === anji){
					...
					alpha.sendMessage(from, result, sticker, { quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true }})
					}
			}
			for (let anju of vien){
				if (budy === anju){
					result = fs.readFileSync(`./media/vn/${anju}.mp3`)
					alpha.sendMessage(from, result, audio, { mimetype: 'audio/mp4', duration: 359996400, ptt: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true}})
					}
			}
			for (let anjh of imagi){
				if (budy === anjh){
					result = fs.readFileSync(`./media/image/${anjh}.jpg`)
					alpha.sendMessage(from, result, image, { quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true}})
					}
			}
...
tod = `┏━━━━━━━━━━━━━━━━━━━━
⬡ ${z}Hari : ${week}${z}
⬡ ${z}Tanggal : ${calender}${z}
⬡ ${z}Nama Bot : ${botName}${z}
⬡ ${z}Nama Owner : ${NamaOwner}${z}
⬡ ${z}Nomor Owner : ${NomorOwner}${z}
┗━━━━━━━━━━━━━━━━━━`
tod2 =`┏━━━❒ *SIMPEL MENU*
${z}冬 ${prefix}soundmenu${z}
${z}冬 ${prefix}jadibot${z}
${z}冬 ${prefix}status${z}
${z}冬 ${prefix}asupanmenu${z}
${z}冬 ${prefix}runtime${z}
${z}冬 ${prefix}makermenu${z}
${z}冬 ${prefix}ownermenu${z}
${z}冬 ${prefix}groupmenu${z}
${z}冬 ${prefix}othermenu${z}
...
━━━━━━━━━━━━━━━━━━`
buttons = [
{buttonId:`scbot`, buttonText: {displayText: 'SC BOT⌛'}, type: 1},
...
────────────────────`
buttons = [
{buttonId:`sc`,buttonText:{displayText: 'Sc Bot'},type:1},
{buttonId:`iklan`, buttonText: {displayText: 'All Menu'}, type: 1}
]
const grup = {
    contentText: `${stamtus}`,
    footerText: `_error atau bug harap lapor ke owner_\n_bot dalam proses pengembangan_\n_mohon maaf jika fitur kurang lengkap_`,
    buttons: buttons,
    headerType: 1
}
...
case 'listmenu':
 ...
 description: `_*Hai Kak Silahkan Dipilih Menunya*_`,
 sections: [
                     {
                      "title": `${time2} - ${week} ${weton} - ${calender}`,
 rows: [
                          {
                              "title": "SEWABOT",
                              "rowId": ""
...
alpha.sendMessage(from, buffer, image, {quoted: fvid, caption: 'Nih Ngab Cecan Random🗿'})
break
case 'hijaber':
ini = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/asupan/hijaber?apikey=${zerkey}`)
sticWait(from)
buffer = await getBuffer(ini.result.url)
alpha.sendMessage(from, buffer, image, {quoted: fvid, caption: 'Nih Jangan Sampe Berdiri yah anunya (≧▽≦)'})
break
case 'santuy':
ini = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/asupan/santuy?apikey=${zerkey}`)
sticWait(from)
buffer = await getBuffer(ini.result.url)
alpha.sendMessage(from, buffer, video, {quoted: fvid, caption: 'Nih Jangan Sampe Berdiri yah anunya (≧▽≦)'})
break
case 'ukhti':
...
alpha.sendMessage(from, pubg, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'smoke': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, smoke, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'bneon': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, bneon, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'matrix': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, matrix, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'gplay': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, gplay, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'splay': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, splay, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'text3d': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, text3d, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'tfire': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, logocrs, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'flame': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, flame, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'flower': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, flower, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'wolf': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
catat = args.join(" ")
sticWait(from)
serti1 = await getBuffer(`https://hansxd.nasihosting.com/serti4/img.php?nama=${catat}`)
alpha.sendMessage(from, serti1, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'serti2': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
catat = args.join(" ")
sticWait(from)
serti2 = await getBuffer(`https://hansxd.nasihosting.com/serti2/img.php?nama=${catat}`)
alpha.sendMessage(from, serti2, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'serti3': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
catat = args.join(" ")
sticWait(from)
serti3 = await getBuffer(`https://hansxd.nasihosting.com/serti6/img.php?nama=${catat}`)
alpha.sendMessage(from, serti3, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'serti4': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
catat = args.join(" ")
sticWait(from)
serti4 = await getBuffer(`https://hansxd.nasihosting.com/serti5/img.php?nama=${catat}`)
alpha.sendMessage(from, serti4, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'logogx': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
catat = args.join(" ")
sticWait(from)
logogx = await getBuffer(`https://api.lolhuman.xyz/api/ephoto1/logogaming?apikey=KurrXd&text=${catat}`)
alpha.sendMessage(from, logogx, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'logogb': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
catat = args.join(" ")
sticWait(from)
logogb = await getBuffer(`https://api.lolhuman.xyz/api/ephoto1/lolbanner?apikey=KurrXd&text=${catat}`)
alpha.sendMessage(from, logogb, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'tomlol': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, tomlol, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'nulis': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, naruto, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'logoff': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, logoff, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'barcode': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, sky, image, { quoted:mek,caption:'Nih Ngab' })
break
case 'cslogo': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
case 'nswifu':
           ...
           sticWait(from)
           bo = args.join(' ')
           wifu = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/waifu?apikey=${lolkey}`)
           await alpha.sendMessage(from, wifu, image, { quoted:mek,caption:'Nsfw By Waifu🗿' })
           } catch(e) { 
              reply(`${e}`)
           }
           break 
case 'nsloli':
           ...
           sticWait(from)
           bo = args.join(' ')
           loli = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/loli?apikey=${lolkey}`)
           await alpha.sendMessage(from, loli, image, { quoted:mek,caption:'Nsfw By Loli🗿' })
           } catch(e) { 
              reply(`${e}`)
           }
           break 
           ...
           sticWait(from)
           bo = args.join(' ')
           neko = await getBuffer(`https://pikeynya.herokuapp.com/api/nsfw/nsfwNeko?apikey=Alphabot`)
           await alpha.sendMessage(from, neko, image, { quoted:mek,caption:'Nsfw By Neko🗿' })
           } catch(e) { 
              reply(`${e}`)
           }
           break 
           ...
           sticWait(from)
           bo = args.join(' ')
           wallnime = await getBuffer(`https://api.lolhuman.xyz/api/random/wallnime?apikey=KurrXd`)
           await alpha.sendMessage(from, wallnime, image, { quoted:mek,caption:'Wallpaper Anime🗿' })
           } catch(e) { 
              reply(`${e}`)
           }
           break 
           ...
           sticWait(from)
           bo = args.join(' ')
           lomlik = await getBuffer(`https://api.lolhuman.xyz/api/random/art?apikey=KurrXd`)
           await alpha.sendMessage(from, lomlik, image, { quoted:mek,caption:'Lomli Ngab🗿' })
           } catch(e) { 
              reply(`${e}`)
           }
           break 
           ...
           sticWait(from)
           bo = args.join(' ')
           blekpink = await getBuffer(`https://api.lolhuman.xyz/api/random/blackpink?apikey=KurrXd`)
           await alpha.sendMessage(from, blekpink, image, { quoted:mek,caption:'Blackpink Nih Ngab🗿' })
           } catch(e) { 
              reply(`${e}`)
           }
           break 
           ...
           sticWait(from)
           bo = args.join(' ')
           hentai = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/hentai?apikey=KurrXd`)
           await alpha.sendMessage(from, hentai, image, { quoted:mek,caption:'Hentaii Nih Ngab🗿' })
           } catch(e) { 
              reply(`${e}`)
           }
           break 
           ...
           sticWait(from)
           bo = args.join(' ')
           bigg = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/biganimetiddies?apikey=KurrXd`)
           await alpha.sendMessage(from, bigg, image, { quoted:mek,caption:'Big Anime Nih Ngab🗿' })
           } catch(e) { 
              reply(`${e}`)
           }
           break 
           ...
           sticWait(from)
           bo = args.join(' ')
           cecan = await getBuffer(`https://api.lolhuman.xyz/api/random/cecan?apikey=KurrXd`)
           await alpha.sendMessage(from, cecan, image, { quoted:mek,caption:'Nih Ngab Ceweknya Lex4you🗿' })
           } catch(e) { 
              reply(`${e}`)
           }
           break
           ...
           sticWait(from)
           bo = args.join(' ')
           sagiri = await getBuffer(`https://api.lolhuman.xyz/api/random/sagiri?apikey=KurrXd`)
           await alpha.sendMessage(from, sagiri, image, { quoted:mek,caption:'By Sagiri🗿' })
           } catch(e) { 
              reply(`${e}`)
           }
           break 
...
alpha.sendMessage(from, `Nih pesannya!`, text, {quoted: cok.messages[i]}) 
}
}
} catch(e) {
console.log(e)
...
alpha.sendMessage(from, `*🎳 Memulai Game Tictactoe 🎲*
...
if (error){ return reply('_[ ! ] Error Teralphai Kesalahan Atau Hasil Tidak Ditemukan_')}
else {
var gugIm = result
...
break
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
				...
				anu = await fetchJson(`https://bx-hunter.herokuapp.com/api/resepmakanan?query=${teks}&apikey=${HunterApi}`, {method: 'get'})
					...
					alpha.sendMessage(from, buff, image, {quoted: ftok, caption: hasilresep})
					break 
					case 'githubstalk':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
					...
					alpha.sendMessage(from, buff, image, {quoted: ftok, caption: gempa})
					break 
				case 'dadu':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
	...
	if (!Number(oi2)) return reply('Jumlah harus berupa angka!')
	  ...
	  break
		...
		const encmediia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
		    ...
		    alpha.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), MessageType.sticker, {quoted: ftex})
...
encmediam = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
			...
			if (!isBotGroupAdmins) return sticNotAdmin(from)
					if (args[0] === 'on') {
						...
						alpha.sendMessage(from, `ALLERT!!! Group ini sudah di pasang antivirtex\nJika Kamu Melanggar Maka Akan Saya Tendang`, text)
					} else if (args[0] === 'off') {
...
await alpha.sendMessage(from, btnasu, MessageType.buttonsMessage, {quoted: ftex})
			...
			if (!isBotGroupAdmins) return sticNotAdmin(from)
					if (args[0] === 'on') {
						...
						alpha.sendMessage(from, `ALLERT!!! Group ini sudah di pasang anti wa.me\nJika Kamu Melanggar Maka Akan Saya Tendang`, text)
					} else if (args[0] === 'off') {
...
await alpha.sendMessage(from, btnasu, MessageType.buttonsMessage, {quoted: ftex})
			...
			if (!isBotGroupAdmins) return sticNotAdmin(from)
					if (args[0] === 'on') {
						...
						alpha.sendMessage(from, `ALLERT!!! Group ini sudah di pasang anti link\nJika Kamu Melanggar Maka Akan Saya Tendang`, text)
					} else if (args[0] === 'off') {
...
case 'tts':
        ...
        if (args.length < 2) return alpha.sendMessage(from, 'Textnya mana gan?', text, {quoted: ftex})
        ngab = budy.slice(7)
        ranm = getRandom('.mp3')
        rano = getRandom('.ogg')
        ngab.length > 600
...
ytmp4 => Video`, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:`SEARCH: ${args[0]}`,body:"◈YOUTUBE SEARCH",mediaType:"2",thumbnail:pporigi,mediaUrl:`https://youtu.be/JN_Gw2GzuqQ`}}})
			...
			case 'ping':
              ...
              sticWait(from)
				...
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					...
					alpha.sendMessage(from, `Sukses, silahkan cek dengan *${prefix}liststicker*`, MessageType.text, { quoted: mek })
					break
				case 'delsticker':
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					try {
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
					...
					alpha.sendMessage(from, `Sukses, silahkan cek dengan *${prefix}listvn*`, MessageType.text, { quoted: mek })
					break
					case 'delvn':
					if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					try {
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
				...
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					...
					alpha.sendMessage(from, `Sukses, silahkan cek dengan *${prefix}listimage*`, MessageType.text, { quoted: mek })
					break
				case 'delimage':
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					try {
		...
		break
case 'kick':
reply(`Gagal kick target! Mungkin Karena Error`)
break
                    case 'creategroup':
			case 'creategrup':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
...
naa = ky_ttt.filter(toek => !toek.id.includes(from)) 
ky_ttt = naa
alpha.sendMessage(from, `Yahh @${tty.player2.split('@')[0]} Menolak:(`,text,{quoted:mek,contextInfo:{mentionedJid:[tty.player2]}})
}
}
